...
void run_conjugate_test(size_t poly_modulus_degree, const vector<int>& coeff_modulus, double scale){
    ...
    for(size_t i = 0; i < input_vector.size(); i++){
        EXPECT_NEAR(input_vector[i].real(),  output_conjugate[i].real(), EPSILON);
        EXPECT_NEAR(input_vector[i].imag(), -output_conjugate[i].imag(), EPSILON);
    }
    ...
    for(size_t i = 0; i < input_vector.size(); i++){
        EXPECT_NEAR(input_vector[i].real(),  output_conjugate_inplace[i].real(), EPSILON);
        EXPECT_NEAR(input_vector[i].imag(), -output_conjugate_inplace[i].imag(), EPSILON);
    }
}

namespace phantomtest{
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest1) {
        run_conjugate_test(65536, {60, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 60}, pow(2.0, 40));
    }
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest2) {
        run_conjugate_test(8192, {60, 30, 30, 30, 60}, pow(2.0, 30));
    }
    ...
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest4) {
        run_conjugate_test(32768, {60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 60}, pow(2.0, 50));
    }
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest5) {
        run_conjugate_test(65536, {60, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 60}, pow(2.0, 50));
    }
    ...
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest7) {
        run_conjugate_test(16384, {50, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 50}, pow(2.0, 30));
    }

    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest8) {
        run_conjugate_test(32768, {60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60}, pow(2.0, 60));
    }
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest9) {
        run_conjugate_test(8192, {30, 30, 30, 30}, pow(2.0, 30));
    }
    TEST(PhantomCKKSBasicOperationsTest, ConjugateOperationTest10) {
        run_conjugate_test(32768, {30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30}, pow(2.0, 30));
    }
}
